...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        $query = mysqli_query($koneksi, "UPDATE mahasiswa SET nama_mahasiswa='$nama', prodi='$prodi', npm='$npm', alamat='$alamat', jenis_kelamin ='$jenis_kelamin' WHERE id=$id") or die(mysqli_error($koneksi));
    } else {
        $query = mysqli_query($koneksi, "INSERT INTO mahasiswa (nama_mahasiswa, prodi, npm, alamat, jenis_kelamin) VALUES ('$nama', '$prodi', '$npm', '$alamat','$jenis_kelamin')") or die(mysqli_error($koneksi));
    }
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <label class="radio inline">
                                      <input type="radio" name="jenis_kelamin" id="jenis_kelamin_perempuan" value="Perempuan"> Perempuan
                                    </label>
                                    <label class="radio inline">
                                        <input type="radio" name="jenis_kelamin" id="jenis_kelamin_tidak_diketahui" value="Tidak diketahui"> Tidak diketahui
                                    </label>
                                </div>
                            </div>
